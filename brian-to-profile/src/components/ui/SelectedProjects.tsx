      ...
      <div className="grid w-full max-w-5xl grid-cols-1 gap-4 px-6 md:grid-cols-3 md:gap-6">
        {PROJECTS.map((p, i) => (
          <motion.article
            ...
            whileHover={{ y: -4 }}
            className="group relative flex flex-col gap-4 overflow-hidden rounded-2xl border border-[var(--color-border-subtle)] p-7 transition-all hover:shadow-xl hover:shadow-black/5"
          >
            ...
            <h3 className="font-headings text-lg font-semibold">{p.title}</h3>
